...
<center>
    ...
    color: #999;
    padding: 2px;">基于移动平台的神经网络搜索研究综述</div>
</center>
...
<center>
    ...
    display: inline-block;
    color: #999;
    padding: 2px;">准确性vs延迟——我们的MnasNet模型在ImageNet上明显优于其他移动模型。详情见表1</div>
</center>
...
$$ \mathop{maximize}\limits_{m} ACC(m)$$

$$ subject\quad to\qquad LAT(m)\le T $$
